...
import { LeafIcon, PulseIcon, LungsIcon, VanSketch } from '@/components/icons';
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-cream">
        <div className="container-content grid items-center gap-10 py-16 md:grid-cols-2 md:py-20">
          <div className="relative z-10">
            <p className="eyebrow">For the woman who knows</p>
            <h1 className="mt-4 font-display text-4xl md:text-5xl lg:text-[3.5rem]">
            ...
            <Link href="/locations" className="mt-8 inline-flex items-center gap-2 text-ink/70 transition-colors hover:text-terracotta">
              <span className="flex h-8 w-8 items-center justify-center rounded-full border border-ink/20">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden><path d="M12 21s-7-6.5-7-11a7 7 0 0 1 14 0c0 4.5-7 11-7 11z"/><circle cx="12" cy="10" r="2.5"/></svg>
              </span>
              <span className="font-body text-sm">
                <span className="block text-[10px] font-bold uppercase tracking-widest text-forest">Testing Locations</span>
                See where I’m testing next →
              </span>
            </Link>
          </div>

          <div className="relative">
            <TopoSwirl className="absolute -left-16 top-1/2 hidden h-64 w-64 -translate-y-1/2 text-forest/30 md:block" />
            {/* PHOTO DIRECTION: strong, current photo of Jessie — warm, direct, real (not stock) */}
            <div className="relative flex aspect-[4/5] items-center justify-center overflow-hidden rounded-lg bg-cream-dark text-center font-body text-sm text-ink/40">
      ...
      {/* Section 3 — What Midlife Can Affect */}
      <Section>
        <div className="mx-auto max-w-3xl">
          ...
          <ul className="mt-8 grid gap-3 font-body text-ink/80 md:grid-cols-2">
            {[
      ...
      {/* Section 4 — Choose Your Starting Point (3 cards) */}
      <Section bg="creamDark" id="start">
        <h2 className="mb-3 text-center text-3xl md:text-4xl">Choose Your Starting Point</h2>
        <div className="mx-auto mt-10 grid max-w-5xl gap-6 md:grid-cols-3">
          ...
          <StartCard
            ...
            price="$295 • Apply the full fee to the Midlife Reboot when you enroll within 14 days"
          ...
          <StartCard
            ...
            price="RMR and VO₂ testing available separately or as part of select offers"
      ...
      {/* Section 6 — About Jessie (split with photo + script accent) */}
      <Section bg="creamLight">
        <div className="mx-auto grid max-w-5xl items-center gap-12 md:grid-cols-2">
          <div className="relative order-2 md:order-1">
            <span className="absolute -left-6 top-1/2 hidden -translate-y-1/2 -rotate-90 font-script text-2xl text-terracotta/80 lg:block">
      ...
      {/* "I bring the lab to you" band (echoes mockup, links to testing) */}
        ...
        <div className="container-content grid items-center gap-6 py-12 md:grid-cols-[auto_1fr_auto]">
          ...
          <div>
            ...
            <p className="mt-2 font-body text-ink/75">
              ...
              partner events. See where I’m testing next and book a test in a city near you.
            </p>
          </div>
...
function StartCard({
  ...
  return (
    <div className="flex flex-col rounded-lg bg-cream-light p-8 ring-1 ring-ink/5">
      ...
      {paras.map((p, i) => (
        <p key={i} className="mt-3 font-body text-sm text-ink/70">
          {p}
        </p>
      ))}
