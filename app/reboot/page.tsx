      ...
      >
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid gap-x-10 gap-y-9 md:grid-cols-2">
            {[
              ['Hormones, symptoms, and access to care', 'Perimenopause, menopause, hysterectomy, hormone therapy, symptom patterns, and the practical side of getting appropriate medical care. That can include helping you understand hormone options, prepare for appointments, identify the questions or data that matter, and get you access to menopause-informed clinicians or telehealth options when you need a prescriber. I do not prescribe medication, but I can help reduce the friction between knowing what needs attention and actually getting it addressed.'],
